...
On each book card under Reading, a third action: **Add to Details.** Tapping it opens a sheet (same pattern as Capture Moment / Update Progress) with four chip inputs:
